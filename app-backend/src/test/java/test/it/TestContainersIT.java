...
// TODO we need to start and stub some mock-server for the domain-backend IN the docker network
@Disabled
@Testcontainers
public class TestContainersIT extends AbstractIT {
    @Container static JeeContainer CONTAINER = new WildflyContainer("20.0.1.Final")
            ...
            .withEnv(MP_REST_CLIENT_CONFIG_KEY, "http://localhost:8081/domain-backend")
